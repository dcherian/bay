...
def read_ra12(minimal=False, avoid_wda=False):
    ...
    ra12.AddChipod(
        810, 15, "mmw", "Turb.mat", dir="../rama/RAMA14/", avoid_wda=avoid_wda
    )
    ra12.AddChipod(
        811, 30, "mm1w", "Turb.mat", dir="../rama/RAMA14/", avoid_wda=avoid_wda
    )
    ra12.AddChipod(
        812, 45, "mm2w", "Turb.mat", dir="../rama/RAMA14/", avoid_wda=avoid_wda
    )
