...
#+BEGIN_SRC jupyter-python
NT2 = xfilter.lowpass(
    all_shears.N2.interpolate_na("time"), freq=1 / 7, cycles_per="D", coord="time"
)

g = (
    (msshear.where(all_shears.u.notnull()) / NT2)
...
g.fig.colorbar(
    ...
    ,**{
        ...
        "aspect": 40,
        "shrink": 0.8,
        "label": "Weekly mean squared shear / 30-day low pass filtered $N²$",
        "extend": "max",
    }
),
