...
** Emails from Sonya
#+BEGIN_QUOTE
Hi Deepak, Happy New Year!
Sure, I'll attach them here. The one from ra123 is the final post-cal file I'd used, with the post-cal 1m and 10m temperature coefficients (and all other temperature coeffs pre-cal) and post-cal salinity coefficients. The one from ra122 is a regular post-cal file (with pre-cal temperature coeffs)...
Take care, -Sonya
#+END_QUOTE

#+BEGIN_QUOTE
 Hi Deepak, I hope all is going well for you and you're enjoying autumn! Sorry about the delay but we did get the ra123 (15n90e, 12/2014-3/2016) post-calibrations back in October and I finally processed and released the ra123 temperatures and salinities, so this email is to let you know they're available. I did end up using the 1m and 10m temperature post-calibration coefficients instead of the usual pre-calibration coefficients, and fortunately that seemed to nicely eliminate the temperature inversions...
I was just finally checking the notes and plots you so kindly sent to me from ra107 and ra122, and am impressed with your processing results, thank you again for sharing them with me. Now that we have the post cals for ra122 I'm working on those as well...
Take care and I hope you'll enjoy the holiday season! :-) -Sonya
#+END_QUOTE
...
** process
#+BEGIN_SRC ipython :session :ipyfile images/temp/imginXBvN.png
