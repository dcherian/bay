...
#+call: read-ra12()
#+BEGIN_SRC ipython :session :file images/ra12-new-summary.png
ax = ra12.Plotχpods(quiv=False, filt='hann', filter_len=5*86400.0,
                    TSkind='pcolor', met='tropflux')
ax['N2'].set_ylim([0, 8])
...
#+BEGIN_SRC ipython :session :file images/2015-miso-surface-subsurface.png
def calc_anom(ds):
...
#+BEGIN_SRC ipython :session :file images/temp/img6437URH.png
olr = calc_anom(tropflux.olr.sel(**subset))
#+END_SRC

#+call: read-ra12()
#+BEGIN_SRC ipython :session :file images/ra12-crosscorr-tau.png
...
#+BEGIN_SRC ipython :session :file images/ra12-crosscorr-curl.png
...
#+BEGIN_SRC ipython :session :file images/temp/img6437AdL.png
...
ax = ra15.Plotχpods(quiv=False, filt='hann', filter_len=3*86400.0,
                    TSkind='pcolor')
ax['Jq'].set_ylim([-100, 100])
# ax['S'].set_ylim([30, 34])
ax['N2'].set_ylim([0, 7])
...
#+BEGIN_SRC ipython :session :file images/temp/img13517bmT.png
...
#+BEGIN_SRC ipython :session :file images/temp/img13517cna.png
...
#+BEGIN_SRC ipython :session :file images/xarray-1d-2d-plot.png
