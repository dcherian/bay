...
ax = ra15.Plotχpods(region={'time': slice('2015-02-20', '2015-03-20')},
                    filt='hann',  filter_len=6*3600)
_ = ax['T'].set_ylim([50,0])
#+END_SRC
#+CAPTION: In this one, the rise in turbulence at 30m coincides with speeds increasing. 30m χpod sees relatively few changes in T_z sign (compare with below)
