...
def make_insets(ax):
    ...
    with plt.style.context('seaborn'):
        insets['ra15'] = ax.inset_axes([98, 14, *wh],
                                     ,**kwargs)
        insets['ra12'] = ax.inset_axes([98, 8, *wh],
                                       ,**kwargs)
        insets['nrl5'] = ax.inset_axes([98, 2, *wh],
                                       ,**kwargs)

        insets['nrl1'] = ax.inset_axes([60, 2,*wh],
                                       ,**kwargs)

        insets['nrl3'] = ax.inset_axes([60, 8, *wh],
                                       ,**kwargs)

        insets['nrl4'] = ax.inset_axes([60, 14, *wh],
                                       ,**kwargs)

        _, conn1 = ax.indicate_inset([nrl4.lon-0.25, nrl4.lat-0.25, 0.5, 0.5],
                                     inset_ax=insets['nrl4'],
                                     transform=ax.transData)

        _, conn2 = ax.indicate_inset([nrl3.lon-0.25, nrl3.lat-0.25, 0.5, 0.5],
...
for mname, moor in zip(['ra12', 'ra15', 'nrl3', 'nrl5'],
                       [ra12, ra15, nrl3, nrl5]):
