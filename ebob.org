...
#+BEGIN_SRC ipython :session :file images/temp/py28335p-H.png
...
#+BEGIN_SRC ipython :session :file images/TS-nrl1.png
...
#+BEGIN_SRC ipython :session :file images/nrl1-kt-boxplot-10min.png
...
#+BEGIN_SRC ipython :session :file images/nrl1-kt-boxplot.png
...
#+BEGIN_SRC ipython :session :file images/temp/img13517cTn.png
...
#+BEGIN_SRC ipython :session :file images/nrl1-summary.png
ax = nrl1.Plotχpods()
...
#+CALL: read-nrl1()
#+BEGIN_SRC ipython :session :file images/nrl1-new-summary.png
...
#+BEGIN_SRC ipython :session :file images/temp/img135175BP.png
...
#+BEGIN_SRC ipython :session :file images/nrl1-500-summary.png
...
#+BEGIN_SRC ipython :session :file images/nrl1-500-chi.png
...
#+BEGIN_SRC ipython :session :file images/nrl1-500-KT.png
...
** 501
#+BEGIN_SRC ipython :session :file images/nrl1-501-summary.png
...
#+BEGIN_SRC ipython :session :file images/nrl3-summary.png
ax = nrl3.Plotχpods()
...
#+BEGIN_SRC ipython :session :file images/TS-nrl5.png
nrl5.TSPlot()
plt.xlim([33.5, 36])
#+END_SRC
...
#+BEGIN_SRC ipython :session :file images/nrl5-proto-spectra.png
...
#+BEGIN_SRC ipython :session :file images/temp/py27662Vq.png
...
#+BEGIN_SRC ipython :session :file images/nrl5-summary.png
nrl5.Plotχpods()
#+END_SRC
...
#+BEGIN_SRC ipython :session :file images/nrl5-boxplot.png
...
** 518
#+BEGIN_SRC ipython :session :file images/518-chi.png
...
** 519
#+BEGIN_SRC ipython :session :file images/519-chi.png
...
#+BEGIN_SRC ipython :session :tangle yes :exports results :eval never-export :file images/nrl1-ctd-dρ.png
PlotNRL(1)
#+END_SRC
...
#+BEGIN_SRC ipython :session :tangle yes :exports results :eval never-export :file images/nrl2-ctd-dρ.png
PlotNRL(2)
#+END_SRC
...
#+BEGIN_SRC ipython :session :tangle yes :exports results :eval never-export :file images/nrl3-ctd-dρ.png
PlotNRL(3)
#+END_SRC
...
#+BEGIN_SRC ipython :session :tangle yes :exports results :eval never-export :file images/nrl4-ctd-dρ.png
PlotNRL(4)
#+END_SRC
...
#+BEGIN_SRC ipython :session :tangle yes :exports results :eval never-export :file images/nrl5-ctd-dρ.png
PlotNRL(5)
#+END_SRC
