...
The spectra also indicated significant energy at frequencies $\le \SI{20}{days}$ especially at NRL3, reflecting meanders of the Summer Monsoon Current.
...
The maximum observed values of $K_T, J_q^t$ and $J_s^t$ at NRL5 occur during the SW monsoon and are associated with a particularly strong set of near-inertial wave packets that forced significantly enhanced turbulence at the χpod's depth (July 23 -- August 7, highlighted in white in Figure [[fig:nrl]]b,c).
