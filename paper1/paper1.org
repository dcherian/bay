...
Processed datasets are available as CF-compliant netCDF files at [[http://www.cherian.net/research/bay]].
...
Multiplying this noise spectral energy density level by frequency bandwidth gives an estimate of the instrument's ``noise floor'' i.e. an estimate of the variance when the data recorded over 1 second is bit noise.
